...
export default function AddTodo({setTodoItems}) {
    ...
    <section className="w-full container bg-violet-950 rounded-lg shadow p-4 mx-auto">
            <form onSubmit={addNewItem} className="flex">
                <input type="text" name="todo" placeholder="New todo List" className="rounded-lg border-s-zinc-300 w-full py-2 px-4 bg-zinc-50 text-zinc-700 placeholder-zinc-400 text-base flex-1"/>
